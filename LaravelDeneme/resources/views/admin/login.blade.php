...
<body>
  ...
  <div class="container  ">
    <div class="row justify-content-center">
      <div class="col-md-4 col-md-offset-4  align-items-center">
      <h4>Admin Giriş Ekranı</h4>
      <hr>
        <form action="{{route('panellogin-user')}}" method="post">
          @csrf
          ...
          <div class="form-group">
            <button class="btn btn-block btn-primary" type="submit">Giriş</button>
          </div>
        </form>
      </div>
    </div>
